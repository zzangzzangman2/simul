...
- 최상위 렌더링 화풍: `art_references/simul_production_soft_painted_vn_style_anchor_v1.png`
- 서하늘 정체성·복장·장신구:
...
```text
Canonical rendering reference: art_references/simul_production_soft_painted_vn_style_anchor_v1.png.
