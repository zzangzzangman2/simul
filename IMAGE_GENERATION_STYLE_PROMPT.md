...
- **기존 얼굴·정체성·헤어·의상을 그대로 유지하는 대상은 데시멀 여자 동기 8명뿐이다.**
  ...
  턱과 볼 비율을 재설계하지 않는다.
- 주인공·김학준·한서윤·국정원/정부 관계자·은행원·공인중개사 등 나머지 인물은
  구형 외형 보존 대상이 아니다. 서사상 역할·나이·성격·필수 소품만 유지하고 새 v3
...
1. 한수아 9종은 2026-08-03 사용자 승인 후 런타임 적용을 완료했다.
2. 다음 인물은 정아린이며, 각자 중립 한 장을 먼저 승인하고 기존 얼굴·헤어·체형·의상과
   포즈를 유지한 채 화풍만 바뀐 경우에만 전체 표정·동작 세트로 확장한다.
3. 이후 나머지 여자 동기 6명도 같은 방식으로 진행한다.
4. 주인공·김학준·한서윤·국정원/정부 인물·은행원·공인중개사 등은 기존 외형 보존 없이
   v3로 새로 설계하고, 중립 또는 대표 포즈 한 장 승인 뒤 전체 세트로 확장한다.
5. 기존 런타임 파일은 대체 세트 전체가 승인되기 전까지 덮어쓰거나 연결 해제하지 않는다.
6. 승인 자산만 `ART_STYLE_AUDIT.md`에 기록하고 런타임에 연결한다.
