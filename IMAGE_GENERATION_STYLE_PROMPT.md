...
- 기존 `art_references/simul_cinematic_soft_painted_style_v1.png`는 과거 제작 비교용일 뿐 신규 캐릭터의 최상위 화풍 기준으로 사용하지 않는다.
...
- 제6기 여학생 8명은 어떠한 경우에도 같거나 비슷한 얼굴을 사용할 수 없다. 머리와 교복을 가린 얼굴만으로도 전원을 즉시 구분해야 한다.
...
- 여자 8명은 모두 동일한 하복 디자인을 사용한다: 흰색 반팔 셔츠, 빨강·검정·흰색 타탄 넥타이, 빨간 타탄 주름치마와 겹친 V자형 하이웨이스트 허리선.
