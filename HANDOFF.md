...
- 실제 작은방 이미지 위 CRT·책상 편지·책상 서랍·가족사진·외출 물건을 누르는 오브젝트 허브
- 책상 편지는 별도 안건함을 거쳐 가족회의로, 책상 서랍은 모달이 아닌 별도 포트폴리오·현금원장 화면으로 이동
...
- 서류함 전체 화면의 가족 투자연구소 상태·오늘 기록과 어머니 명의·생활비 분리 안내
...
- 360×800 회귀 검증: 프롤로그 16장면 인물, 320px 키보드 입력, 작은방 오브젝트 터치 영역, 종목·경영진 초상, 조직 카드, 일거리 3종, 뉴스 팝업의 경계 이탈 없음
...
- 추후 구현할 전화는 초반에 가족·증권사 기능만 제공하고 M&A 전화는 성장 후 해금합니다. 현재 Flutter에는 전화 장면이 없습니다.
