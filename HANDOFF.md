...
- 현재 대사 버전: content 3 / appearance 19 / 292장면
...
- 1999년 국정원·정부 인물 6명(한규진·임서희·도윤석·조민경·차은주·오경태)은
  ...
  한서윤·은행원·공인중개사 등 남은 부적합 인물도 역할·
  나이·성격·장면 기능만 이어받아 전면 재설계한다. 삭제·격리한 구형 정부·정책실
  자산은 되살리지 않는다.
...
- 데시멀톡은 9명 MBTI별 성격·6단계 관계·7종 투자 상황·12종 입력 의도·과거 기억을 Gemini 3.5 Flash-Lite에 전달한다. 실패하면 12만 가지 이상의 로컬 조합 답장으로 전환하며 구조화 기억은 최대 512개를 보존한다.
