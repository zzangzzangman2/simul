...
/// 2000~2026년에 확산된 기술 흐름을 게임용 가상 기술로 추상화한다.
...
const fictionalEraTechnologies = <FictionalEraTechnology>[
  ...
  FictionalEraTechnology(
    id: 'mobile_lte_ecosystem',
    name: '광대역 모바일 생태계',
    firstYear: 2011,
    lastYear: 2011,
    sectors: ['통신·네트워크', '반도체', '소프트웨어', '인터넷'],
    successImpact: 0.21,
    failureImpact: 0.20,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2011,
    lastYear: 2011,
    sectors: ['인터넷', '유통', '소프트웨어', '물류'],
    successImpact: 0.19,
    failureImpact: 0.21,
  ),
  FictionalEraTechnology(
    id: 'large_oled_display',
    name: '대형 유기발광 화면',
    firstYear: 2012,
    lastYear: 2012,
    sectors: ['디스플레이', '첨단소재', '반도체', '전자·가전'],
    successImpact: 0.22,
    failureImpact: 0.23,
  ),
  FictionalEraTechnology(
    id: 'public_cloud_saas',
    name: '공용 클라우드 업무서비스',
    firstYear: 2012,
    lastYear: 2012,
    sectors: ['소프트웨어', '인터넷', '정보보안'],
  ...
  FictionalEraTechnology(
    id: 'mobile_fintech_remittance',
    name: '모바일 간편송금·결제',
    firstYear: 2013,
    lastYear: 2013,
    sectors: ['금융기술', '금융', '정보보안', '소프트웨어'],
    successImpact: 0.21,
    failureImpact: 0.22,
  ),
  FictionalEraTechnology(
    id: 'collaborative_industrial_robot',
    name: '협동형 산업로봇',
    firstYear: 2013,
    lastYear: 2013,
    sectors: ['로봇', '정밀기기', '자동차', '조선·기계'],
    successImpact: 0.19,
    failureImpact: 0.21,
  ),
  FictionalEraTechnology(
    id: 'wearable_health_sensor',
    name: '착용형 건강센서',
    firstYear: 2014,
    lastYear: 2014,
    sectors: ['의료기기', '정밀기기', '반도체', '소프트웨어'],
    successImpact: 0.20,
    failureImpact: 0.21,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2014,
    lastYear: 2014,
    sectors: ['전지', '에너지', '전력·유틸리티', '전력기기'],
    successImpact: 0.20,
    failureImpact: 0.23,
  ),
  FictionalEraTechnology(
    id: 'fifth_generation_radio_trial',
    name: '초고속 무선망 시험서비스',
    firstYear: 2015,
    lastYear: 2015,
    sectors: ['통신·네트워크', '반도체', '반도체장비', '정보보안'],
    successImpact: 0.21,
    failureImpact: 0.21,
  ),
  FictionalEraTechnology(
    id: 'biosimilar_export_platform',
    name: '바이오의약품 대량생산·수출',
    firstYear: 2015,
    lastYear: 2015,
    sectors: ['바이오', '제약', '의료기기'],
  ...
  FictionalEraTechnology(
    id: 'deep_learning_vision',
    name: '심층학습 영상인식',
    firstYear: 2016,
    lastYear: 2016,
    sectors: ['소프트웨어', '인터넷', '반도체', '정보보안'],
    successImpact: 0.23,
    failureImpact: 0.22,
  ),
  FictionalEraTechnology(
    id: 'connected_vehicle_autonomy',
    name: '연결형 자율주행 보조',
    firstYear: 2016,
    lastYear: 2016,
    sectors: ['자동차', '정밀기기', '반도체', '통신·네트워크'],
    successImpact: 0.22,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    id: 'high_bandwidth_memory',
    name: '초고대역 적층메모리',
    firstYear: 2017,
    lastYear: 2017,
    sectors: ['반도체', '반도체장비', '첨단소재'],
    successImpact: 0.24,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2017,
    lastYear: 2017,
    sectors: ['소프트웨어', '인터넷', '전력·유틸리티', '전력기기'],
    successImpact: 0.21,
    failureImpact: 0.22,
  ),
  FictionalEraTechnology(
    id: 'foldable_display_device',
    name: '접이식 화면 단말',
    firstYear: 2018,
    lastYear: 2018,
    sectors: ['디스플레이', '전자·가전', '첨단소재', '반도체'],
    successImpact: 0.23,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    id: 'fifth_generation_equipment',
    name: '초고속 무선망 상용장비',
    firstYear: 2018,
    lastYear: 2018,
    sectors: ['통신·네트워크', '반도체', '반도체장비', '정보보안'],
  ...
  FictionalEraTechnology(
    id: 'subscription_streaming_content',
    name: '구독형 영상·음원 플랫폼',
    firstYear: 2019,
    lastYear: 2019,
    sectors: ['미디어', '엔터테인먼트', '인터넷', '소프트웨어'],
    successImpact: 0.22,
    failureImpact: 0.22,
  ),
  FictionalEraTechnology(
    id: 'hydrogen_mobility',
    name: '수소 운송·충전 생태계',
    firstYear: 2019,
    lastYear: 2019,
    sectors: ['자동차', '에너지', '화학·소재', '전력기기'],
    successImpact: 0.21,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    id: 'programmable_vaccine_platform',
    name: '프로그래밍형 백신 플랫폼',
    firstYear: 2020,
    lastYear: 2020,
    sectors: ['바이오', '제약', '의료기기'],
  ...
  FictionalEraTechnology(
    ...
    firstYear: 2020,
    lastYear: 2020,
    sectors: ['정보보안', '소프트웨어', '인터넷', '통신·네트워크'],
    successImpact: 0.22,
    failureImpact: 0.21,
  ),
  FictionalEraTechnology(
    id: 'virtual_world_creator_economy',
    name: '가상세계·창작자 경제',
    firstYear: 2021,
    lastYear: 2021,
    sectors: ['게임', '미디어', '엔터테인먼트', '인터넷', '소프트웨어'],
    successImpact: 0.23,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2021,
    lastYear: 2021,
    sectors: ['전지', '환경', '첨단소재', '자원개발'],
    successImpact: 0.20,
    failureImpact: 0.22,
  ),
  FictionalEraTechnology(
    id: 'generative_language_model',
    name: '생성형 언어·콘텐츠 모델',
    firstYear: 2022,
    lastYear: 2022,
    sectors: ['소프트웨어', '인터넷', '반도체', '정보보안', '미디어'],
    successImpact: 0.25,
    failureImpact: 0.23,
  ),
  FictionalEraTechnology(
    id: 'modular_clean_power_grid',
    name: '모듈형 청정전원·지능형 전력망',
    firstYear: 2022,
    lastYear: 2022,
    sectors: ['전력·유틸리티', '전력기기', '에너지', '건설'],
    successImpact: 0.22,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
    id: 'chiplet_ai_accelerator',
    name: '칩렛형 인공지능 가속기',
    firstYear: 2023,
    lastYear: 2023,
    sectors: ['반도체', '반도체장비', '첨단소재', '소프트웨어'],
    successImpact: 0.25,
    failureImpact: 0.25,
  ),
  FictionalEraTechnology(
    id: 'autonomous_defense_drone',
    name: '자율형 방산 무인기',
    firstYear: 2023,
    lastYear: 2023,
    sectors: ['방산', '항공·우주', '로봇', '정보보안'],
    successImpact: 0.23,
    failureImpact: 0.25,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2024,
    lastYear: 2024,
    sectors: ['반도체', '전자·가전', '소프트웨어', '정밀기기'],
    successImpact: 0.24,
    failureImpact: 0.23,
  ),
  FictionalEraTechnology(
    id: 'humanoid_general_robot',
    name: '범용 휴머노이드 로봇',
    firstYear: 2024,
    lastYear: 2024,
    sectors: ['로봇', '정밀기기', '반도체', '전지'],
    successImpact: 0.24,
    failureImpact: 0.26,
  ),
  FictionalEraTechnology(
    id: 'enterprise_ai_agent',
    name: '기업용 인공지능 업무대리인',
    firstYear: 2025,
    lastYear: 2025,
    sectors: ['소프트웨어', '인터넷', '정보보안', '금융기술'],
    successImpact: 0.24,
    failureImpact: 0.23,
  ),
  FictionalEraTechnology(
    id: 'solid_state_battery_pilot',
    name: '전고체 전지 양산시험',
    firstYear: 2025,
    lastYear: 2025,
    sectors: ['전지', '첨단소재', '자동차', '반도체장비'],
    successImpact: 0.25,
    failureImpact: 0.27,
  ),
  FictionalEraTechnology(
    ...
    firstYear: 2026,
    lastYear: 2026,
    sectors: ['정보보안', '통신·네트워크', '소프트웨어', '반도체'],
    successImpact: 0.23,
    failureImpact: 0.24,
  ),
  FictionalEraTechnology(
