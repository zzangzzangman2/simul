...
const cohortCharacterProfiles = <CohortCharacterProfile>[
  ...
  CohortCharacterProfile(
    ...
    name: '한서윤',
    age: 23,
    group: '미래양성원 제6기 투자교육 담당',
    mbti: 'INFJ',
    role: '투자교육 교사 · 판단 기준 안내자',
    summary: '학생의 질문을 끝까지 듣고 스스로 판단할 기준을 세워 주는 지도교사.',
    personality:
        '답을 대신 정해 주기보다 학생이 관찰한 사실과 선택 이유를 말하게 한다. 차분하고 다정하지만 불공정한 제도나 숨긴 위험을 좋은 말로 포장하지 않는다.',
    likes: '솔직한 투자노트, 핵심을 찌르는 질문, 스스로 고친 판단, 조용한 복습 시간',
    strength: '어려운 시장 개념을 생활어로 풀고 각 학생의 질문을 하나의 판단 기준으로 연결한다.',
    investmentView: '매수 이유와 매도 조건을 기록하고 손실 가능성까지 설명할 수 있어야 투자로 인정한다.',
    relationshipStyle: '학생을 한 유형으로 단정하지 않고 말이 끝날 때까지 들은 뒤 정확한 질문으로 되돌려 준다.',
