...
final List<MissionDefinition> missionCatalog = <MissionDefinition>[
  _mission(
    ...
    '1장 · 국가계좌 장부',
    '첫 조사 원칙을 정하자',
    '데시멀 전략회의에서 어떤 기준으로 회사를 볼지 선언하면 첫 장부가 시작된다.',
    'decisions_resolved',
    1,
    '첫 기업 조사노트 안건 해결',
    80,
  ...
  _mission(
    ...
    '1장 · 국가계좌 장부',
    '내 손으로 첫 돈 벌기',
    '국가원금과 직접 번 돈을 구분해 기록하려면 작은 원내 활동부터 직접 해내야 한다.',
    'work_sessions',
    1,
    '일거리 1회 완료',
    70,
  ...
  _mission(
    ...
    '1장 · 국가계좌 장부',
    '직접 번 돈 만원 모으기',
    '국가원금과 별도로, 원내 활동으로 직접 번 돈을 첫 운용금 장부에 기록한다.',
    'earned_seed',
    10000,
    '직접 번 돈 누적 10,000원',
    130,
  ...
  _mission(
    ...
    '3장 · 투자 습관',
    '세 번 설명하고 결정하기',
    '결정의 결과보다 동기에게 이유를 설명하는 과정이 투자 원칙을 만든다.',
    'decisions_resolved',
    3,
    '누적 안건 3건 해결',
    140,
  ...
  _mission(
    ...
    '4장 · 작은 운용사',
    '데시멀 동기와 두 번 교차검토하기',
    '혼자 놓친 숫자를 동기와 담당 운영관의 다른 시선으로 다시 확인한다.',
    'academy_help',
    2,
    '데시멀 동기 교차검토 누적 2회',
    140,
  ...
  _mission(
    ...
    '6장 · 반복 가능한 원칙',
    '여덟 번의 선택 기록',
    '어떤 선택이 조직과 데시멀 동기 공동체에 어떤 결과를 남겼는지 되짚는다.',
    'decisions_resolved',
    8,
    '누적 안건 8건 해결',
    220,
  ...
  _mission(
    ...
    '8장 · 돈을 쓰는 이유',
    '성장을 위한 첫 소비',
    '무조건 아끼지 말고 교육·자료·공동생활·사업 중 목적이 분명한 곳에 돈을 쓴다.',
    'finance_purchases',
    1,
    '자산·소비 계획 1회 실행',
    240,
...
const List<SkillDefinition> skillCatalog = <SkillDefinition>[
  ...
  SkillDefinition('cohort_briefing', 6, '데시멀 동기 브리핑', '안건 해결 시 공동체 신뢰 +1'),
