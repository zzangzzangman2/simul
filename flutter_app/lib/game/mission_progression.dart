...
final List<MissionDefinition> missionCatalog = <MissionDefinition>[
  _mission(
    ...
    '1장 · 국가계좌 장부',
    '첫 조사 원칙을 정하자',
    '제6기 연구회의에서 어떤 기준으로 회사를 볼지 선언하면 첫 장부가 시작된다.',
    'decisions_resolved',
    1,
    '첫 기업 조사노트 안건 해결',
    80,
  ...
  _mission(
    ...
    '1장 · 국가계좌 장부',
    '국가원금 1만원 기록',
    '미래양성기금 국가원금 10,000원을 생활비와 분리해 첫 운용금으로 기록한다.',
    'earned_seed',
    10000,
    '종잣돈 10,000원 확인',
    130,
  ...
  _mission(
    ...
    '4장 · 작은 운용사',
    '제6기와 두 번 교차검토하기',
    '혼자 놓친 숫자를 동기와 담당 교사의 다른 시선으로 다시 확인한다.',
    'academy_help',
    2,
    '제6기 교차검토 누적 2회',
    140,
  ...
  _mission(
    ...
    '6장 · 반복 가능한 원칙',
    '여덟 번의 선택 기록',
    '어떤 선택이 조직과 제6기 공동체에 어떤 결과를 남겼는지 되짚는다.',
    'decisions_resolved',
    8,
    '누적 안건 8건 해결',
    220,
...
const List<SkillDefinition> skillCatalog = <SkillDefinition>[
  ...
  SkillDefinition('cohort_briefing', 6, '제6기 브리핑', '안건 해결 시 공동체 신뢰 +1'),
