...
- 시장 화면에서 현실 1초마다 게임 1분 진행, 08:00~08:59 이전 종가 고정, 09:00부터 게임용 1분봉 생성, 15:30 실제 종가 확정 뒤 20:00까지 거래·분봉 없이 종가 유지
...
1. 생활 단서→첫 기업 조사→투자 제안서→부모 승인·수정→첫 주문→장 마감 가족 반응·투자일지 흐름 연결
2. KRX 계정·재배포 권한 확인 후 상장폐지 종목을 포함한 전 종목 원장 생성
3. 실제 기기에서 이름 키보드, 대화 속도, 터치 영역과 작은 화면 가독성 검수
4. 구현된 2003년 채용 이후 부서 배치·교육·퇴사와 조직 성장 콘텐츠 확장
5. 일거리 미니게임 사운드·난이도와 앱 아이콘·배포용 Web 호스팅 정리
