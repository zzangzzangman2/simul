...
- 실제 작은방 이미지의 CRT·안건 편지·서류 서랍·사람들·일거리 오브젝트 허브
- 편지함과 포트폴리오·현금원장을 방과 분리한 전용 장면
...
| 경로 | 역할 |
| --- | --- |
| `lib/main.dart` | 앱 상태, 날짜 진행과 저장 |
| `lib/room_screens.dart` | 실제 작은방 오브젝트 허브, 안건함과 서류함 전용 장면 |
