...
- KRX·NASDAQ·TSE 실제 기업 9개와 날짜별 역사 소식 400여 건
...
Flutter 테스트 36개가 게임 엔진, 저장 마이그레이션, 스토리, 미니게임, 시장 소식, 경영진 데이터와 화면 동작을 검증합니다. 레이아웃 회귀 테스트는 `360×800`과 `390×844` 세로 화면에서 배경·인물·카드·종목 상세가 화면 밖으로 넘치지 않는지 확인합니다.
