...
void main() {
  ...
  const assets = <String>[
    'character_girlfriend_neutral_v3.png',
    'character_girlfriend_smile_v3.png',
    'character_girlfriend_laugh_v3.png',
    'character_girlfriend_cry_v3.png',
    'character_girlfriend_pout_v3.png',
    'character_girlfriend_shy_v3.png',
  ];

  test('girlfriend sprites share the canonical canvas and baseline', () async {
    for (final asset in assets) {
      ...
      expect(minimumX, greaterThan(0), reason: asset);
      expect(maximumX, lessThan(image.width - 1), reason: asset);
