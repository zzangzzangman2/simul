...
2026-08-03 화면 회귀 재검수에서 단순 알파 보정으로는 원본에 구워진 체크무늬·흰 매트를
완전히 없앨 수 없음을 확인했다. 따라서 문제가 확인된 정아린 9종, 한수아 03~09 7종,
오지우 9종, 박하은 9종 등 총 34종은 정식 v3 화풍 앵커와 각 인물 승인 정체성 앵커를
함께 사용해 새로 생성했다. 한수아 03 웃음은 큰 입과 과장된 양팔 동작을 폐기하고 작은
웃음과 한 손 반응으로 다시 제작했다.

여자 동기 8명 72종과 1999년 국정원·정부 인물 6종, 총 78종은 원본 RGBA를 검정·청록
배경에 각각 합성해 다시 전수검수했다. 새로 생성하지 않은 나머지 자산은 체크무늬·흰
매트·밝은 외곽선이 보이지 않는 것만 유지했다. 정식 v3 화풍 앵커는 한수아 중립 전신
정리본과 동일한 RGBA 픽셀을 유지한다.
