...
- 국내 기본 팩 22개 투자와 기존 해외 6개 종목의 별도 탭 보존
...
현재 자동 검증은 엔진·스토리·미니게임·경영진·시장소식과 `360×800`, `390×844` 세로 화면 레이아웃을 포함한 Flutter 테스트 52개입니다.
...
- 첫 기업 조사노트, 자동 저장과 v7 스토리·조직 마이그레이션
...
- Flutter v1·v4·v5 저장을 상태 스키마 v7로 보존 마이그레이션
