...
- 현재가·최근 체결가는 직전 실제 체결가격이고, 최우선 ask/bid는 남은 주문 중
  ...
  서로 다른 가격으로 표시하지 않는다.
- 호가 펄스는 게임분당 거래대금 기본 `1·1·2·3·5·7·9·11·12회`, 급변
  16회, 극단 20회다. 20~75억원 구간은 1회/분이며, 75억원 미만 종목은
  체결강도 불균형만으로 가속하지 않는다. 75억원 이상도 최근 3시장분에 최소
  3건·합계 0.10억원 이상의 체결 표본이 있어야 불균형 가속하며, 부족하면
  기본 슬롯을 유지한다. 값·막대·빨간 테두리는 144ms로 보간한다.
