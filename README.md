...
가르치는 국립 미래양성원을 세웁니다. 2000년, 새봄보육원에서 선발된 10살
...
`SEED 05~07 투자왕`과 `SEED 08~10 투자왕`은 향후 배틀 시스템으로
확장합니다. 누적 자산으로 어린 교육생을 누르는 방식이 아니라 같은 시작자본,
...
현재 런타임의 리부트 프롤로그는 아래 1번의 제6기 오리엔테이션까지 연결되어
...
8. SEED 01부터 SEED 10까지 판단 장부와 자산을 키우고 국가계좌 명의이전 협상을 준비한다.
...
현재 저장 스키마는 v20입니다. 리부트 저장 모델은 1991년생 주인공,
...
| [PROTAGONIST_AGE_LINE.md](./PROTAGONIST_AGE_LINE.md) | 10~19살 실제 나이와 SEED 01~10 성장선 |
