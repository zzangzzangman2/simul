...
`app/data/market-history.json`은 2026-07-20에 Yahoo Finance chart endpoint에서 받은 월별 adjusted close를 사용합니다. 종목마다 첫 가용 기준월을 100으로 정규화했기 때문에 숫자는 당시 실제 호가가 아니라 **분할·배당을 반영한 상대 수익률 지수**입니다.
...
게임은 2000-01부터 2010-12까지 132개월을 제공합니다. 미국 종목과 Toyota는 1999-12를 기준월로 사용하고, 해당 월 데이터가 응답에 없던 KRX 종목·Sony·SoftBank는 2000-01을 기준월로 사용합니다.
